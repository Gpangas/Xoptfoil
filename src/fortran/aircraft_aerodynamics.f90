...
subroutine aircraft_aerodynamics_level(Cl, Cd, n, h, V, drag, thurst, converge)
  ...
  use vardef, only : weight, A_w, e_w, S_w, S_expose,fuselage, CD_add, CD_ld,  &
  ...
  CD_t = Cd + CD_i + CD_fus + CD_tail + CD_ld + CD_add
...
subroutine aircraft_aerodynamics_take_off(Cl, Cd, n, h, V, Cl_a, Cd_t, thurst, &
  ...
  use vardef, only : A_w, e_w, S_w, S_expose,fuselage, CD_ld, CD_add,          &
                       thrust_coeff, niteration_lift, lift_converge_limit
