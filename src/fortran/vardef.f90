...
! Data structures for airfoil optimization code
  ...
  type cruise_type
    ...
    double precision :: V, t_accel, dist_accel, dist
...
! routines)
  ...
  double precision, dimension(max_addthickconst) :: addthick_x, addthick_min,  &
                                                    addthick_max
  double precision :: weight_min, climb_rate_min, cruise_speed_min,            &
                      turn_speed_min
  ...
  double precision :: time_climb, h_climb, dh_climb, V_0_climb
  double precision, dimension(5) :: points_coeff
